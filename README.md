...
<p align="center">
  ...
  &nbsp;
  <img src="docs/screenshots/plant-detail.jpg" width="220" alt="Plant detail with health and watering records" />
  &nbsp;
  <img src="docs/screenshots/reminders.jpg" width="220" alt="Watering reminders ledger" />
</p>

<p align="center">
  <img src="docs/screenshots/guide-library.jpg" width="220" alt="Plant-care guide library" />
  &nbsp;
  <img src="docs/screenshots/guide-article.jpg" width="220" alt="Plant-care guide article" />
  &nbsp;
  <img src="docs/screenshots/field-capture.jpg" width="220" alt="Plant field-capture screen" />
</p>
...
| **Guide** | Read practical field notes about watering, light, soil, pests, and seasonal care. |
...
The README gallery is generated by the `PlantPalBuildScreenshots` UI-test target in a seeded simulator guest session. Run this after visual changes:

```bash
./scripts/capture-readme-screenshots.sh
```

Set `SIMULATOR_NAME` to target another installed simulator. The script writes the generated JPEGs to `docs/screenshots/`.
