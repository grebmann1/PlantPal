...
enum ImageCompressor {
    ...
    static func prepareForAI(_ image: UIImage, maxDimension: CGFloat = 1024, quality: CGFloat = 0.7) -> Data {
        ...
        return resized.jpegData(compressionQuality: quality) ?? normalized.jpegData(compressionQuality: quality) ?? Data()
    }
    ...
    /// Bakes EXIF orientation into pixel buffers so JPEG payloads match what the user saw.
